            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              {filteredActive.map((trade) => {
                ...
                return (
                  ...
                  >
                    <div>
                      {/* Top Header: Bot Serial, Symbol & Status */}
                        ...
                        <div className="flex items-center gap-2.5">
                          ...
                          <div>
                            <div className="flex items-center gap-1.5">
                              ...
                              <span className={`px-1.5 py-0.2 rounded text-[10px] font-bold ${isLong ? 'bg-emerald-50 text-emerald-700 border border-emerald-200' : 'bg-rose-50 text-rose-700 border border-rose-200'}`}>
                                {trade.direction} {trade.leverage}x
                              </span>
                            </div>
                            <div className="text-[11px] text-slate-500 font-medium">{trade.botName}</div>
                          </div>
                        </div>
                      ...
                      <div className="grid grid-cols-3 gap-2 p-2.5 rounded-xl bg-slate-50 border border-slate-200 text-xs mb-3 shadow-2xs">
                        ...
                        <div>
                          <div className="text-[10px] uppercase font-bold text-slate-500">Stop Loss</div>
                      ...
                      <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-200 text-[11px] text-slate-600 mb-3">
                        <div className="flex items-center gap-1 text-slate-800 font-bold mb-0.5">
                          <ShieldCheck className="w-3.5 h-3.5 text-emerald-600" />
                          <span>10-Rule Confirmation Rationale ({trade.confirmedRulesCount}/10 Confirmed):</span>
                        </div>
