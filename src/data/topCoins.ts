...
export const VERIFIED_COINS_DATA: VerifiedCoinData[] = [
  ...
  { rank: 21, symbol: 'OP', name: 'Optimism', price: 0.0970, change24h: 2.10, volume24h: 110000000, marketCap: 1350000000, category: 'Layer 2', network: 'OP Mainnet (L2)', contractAddress: '0x4200000000000000000000000000000000000042', cmcSlug: 'optimism-ethereum' },
